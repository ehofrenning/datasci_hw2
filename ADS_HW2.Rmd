...
First, I create a function that is fed an explainer, an observation, and the variable of interest. Then, the function creates a prediction profile using the dalex package and spits out a plot of how the predictions are affected when my variable of interest changes.
