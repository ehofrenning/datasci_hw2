...
Now, I do the same thing as above but tune according to ROC AUC for the metric:
```{r}
...
```{r}
# ROC auc 
best_auc <- select_best(lending_forest_tune, "roc_auc")
best_auc
# Accuracy
best_acc <-
lending_forest_tune %>%
...
# final model using best ROC AUC
